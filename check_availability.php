...
$opass=$result;
if($opass==$pass) 
echo "<span style='color:green'> Contraseña Guardada .</span>";
else echo "<span style='color:red'> Contraseña No Guardada</span>";
}
...
$stmt->close();
if($count>0)
echo "<span style='color:red'>$count. Asientos ya llenos.</span>";
else
	echo "<span style='color:red'>Todos los asientos están disponibles</span>";
}
?>