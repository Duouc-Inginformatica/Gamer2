...
Ultima actualizacion : &nbsp; <?php echo $row->updationDate;?> 
</div>
...
<label class="col-sm-2 control-label"> Registracion No : </label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Contacto No : </label>
<div class="col-sm-8">
