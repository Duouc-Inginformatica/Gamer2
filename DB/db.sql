...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-06-2022 a las 00:50:07
...
--
-- Estructura de tabla para la tabla `categoria_valp`
--

CREATE TABLE `categoria_valp` (
  `id` int(11) NOT NULL,
  `nombre` varchar(80) DEFAULT NULL,
  `imagen` varchar(255) DEFAULT NULL,
  `fecha_creada` datetime DEFAULT NULL
...
--
-- Volcado de datos para la tabla `categoria_valp`
--

INSERT INTO `categoria_valp` (`id`, `nombre`, `imagen`, `fecha_creada`) VALUES
(1, 'Personal', 'conference.jpg', '2018-02-15 09:14:21'),
(2, 'Doble', NULL, '2019-02-26 11:39:02'),
(3, 'Triple', NULL, '2019-02-26 11:39:08'),
(4, 'Cuatruple', NULL, '2019-02-26 11:40:17'),
...
(1, 'HOTEL VERANUM', 'DIRECCION EXACTA', 'SANTIAGO', '+52 1 953 114 9', 'NULL', '0038947384786', 'NULL', 'SANTIAGO', '122321_1.png');
...
--
-- Estructura de tabla para la tabla `habitacion_valp`
--

CREATE TABLE `habitacion_valp` (
  `id` int(11) NOT NULL,
  `nombre` varchar(50) DEFAULT NULL,
  `descripcion` varchar(100) DEFAULT NULL,
  `precio` double DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `habitacion_valp`
--

INSERT INTO `habitacion_valp` (`id`, `nombre`, `descripcion`, `precio`, `id_categoria`, `estado`, `capacidad`, `fecha_creada`) VALUES
(112, '101', 'Con cama de 2 plazas, una TV, Cable', 0, 2, 1, 1, '2022-02-26 11:42:02'),
(114, '503', 'Con cama de 2 plazas, una TV, Cable', 0, 1, 1, 1, '2022-02-26 11:49:30');
...
(52, 2, '71895719', 'NULL', 'BASTIAN SILVA', '1973-09-11', 'NULL', 'Las condes #140541', '2019-03-01 09:38:51', 1, 0, 0, 7, 'Peruana', 'SOLTERO', 'Estudiante', 'Bus', 'Lima', 'Trusimo', NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `persona_valp`
--

CREATE TABLE `persona_valp` (
  `id` int(11) NOT NULL,
  `tipo_documento` int(11) DEFAULT NULL,
  `documento` varchar(12) DEFAULT NULL,
  `giro` varchar(255) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `persona_valp`
--

INSERT INTO `persona_valp` (`id`, `tipo_documento`, `documento`, `giro`, `nombre`, `fecha_nac`, `razon_social`, `direccion`, `fecha_creada`, `tipo`, `vip`, `contador`, `limite`, `nacionalidad`, `estado_civil`, `ocupacion`, `medio_transporte`, `destino`, `motivo`, `telefono`, `celular`) VALUES
...
--
-- Estructura de tabla para la tabla `proceso_valp`
--

CREATE TABLE `proceso_valp` (
  `id` int(11) NOT NULL,
  `id_habitacion` int(11) DEFAULT NULL,
  `id_tarifa` int(11) DEFAULT NULL,
  `id_cliente` int(11) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `proceso_venta_valp`
--

CREATE TABLE `proceso_venta_valp` (
  `id` int(11) NOT NULL,
  `id_producto` int(11) DEFAULT NULL,
  `id_operacion` int(11) DEFAULT NULL,
  `id_venta` int(11) DEFAULT NULL,
...
(3, 'PRO-169', 'coca-cola', 'CoCa-CoLa', 'Personal 500Cc', 'Bebida en botella plastica', 600, 1500, 69, 65971, '2022-06-26 16:40:18');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `producto_valp`
--

CREATE TABLE `producto_valp` (
  `id` int(11) NOT NULL,
  `codigo` varchar(10) DEFAULT NULL,
  `nombre` varchar(50) DEFAULT NULL,
  `marca` varchar(50) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `producto_valp`
--

INSERT INTO `producto_valp` (`id`, `codigo`, `nombre`, `marca`, `descripcion`, `presentacion`, `precio_compra`, `precio_venta`, `stock`, `id_proveedor`, `fecha_creada`) VALUES
...
--
-- Estructura de tabla para la tabla `tarifa_habitacion_valp`
--

CREATE TABLE `tarifa_habitacion_valp` (
  `id` int(11) NOT NULL,
  `id_tarifa` int(11) DEFAULT NULL,
  `id_habitacion` int(11) DEFAULT NULL,
  `precio` double DEFAULT NULL
...
--
-- Volcado de datos para la tabla `tarifa_habitacion_valp`
--

INSERT INTO `tarifa_habitacion_valp` (`id`, `id_tarifa`, `id_habitacion`, `precio`) VALUES
(17, 8, 6, 380),
(18, 7, 6, 580),
(19, 9, 6, 700),
(20, 10, 6, 800),
...
--
-- Estructura de tabla para la tabla `tarifa_valp`
--

CREATE TABLE `tarifa_valp` (
  `id` int(11) NOT NULL,
  `nombre` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `tarifa_valp`
--

INSERT INTO `tarifa_valp` (`id`, `nombre`) VALUES
(1, '24 Horas'),
(4, '12 horas'),
(7, 'Doble'),
(8, 'Personal'),
...
(1, 3, 4, 1500, 'm1klmhk7qp7qah9fbs894o7cs3', 1);
...
(1, 'Administrador', 'muñoz', 'seba', 'seba@gmail.com', '0937afa17f4dc08f3c0e5dc908158370ce64df86', NULL, 1, 1, '2016-12-13 09:08:03', 0);
...
--
-- Indices de la tabla `categoria_valp`
--
ALTER TABLE `categoria_valp`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `habitacion_valp`
--
ALTER TABLE `habitacion_valp`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `persona_valp`
--
ALTER TABLE `persona_valp`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `proceso_valp`
--
ALTER TABLE `proceso_valp`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `proceso_venta_valp`
--
ALTER TABLE `proceso_venta_valp`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `producto_valp`
--
ALTER TABLE `producto_valp`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tarifa_habitacion_valp`
--
ALTER TABLE `tarifa_habitacion_valp`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tarifa_valp`
--
ALTER TABLE `tarifa_valp`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `categoria_valp`
--
ALTER TABLE `categoria_valp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT de la tabla `habitacion_valp`
--
ALTER TABLE `habitacion_valp`
...
--
-- AUTO_INCREMENT de la tabla `persona_valp`
--
ALTER TABLE `persona_valp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
-- AUTO_INCREMENT de la tabla `proceso_valp`
--
ALTER TABLE `proceso_valp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
...
--
-- AUTO_INCREMENT de la tabla `proceso_venta_valp`
--
ALTER TABLE `proceso_venta_valp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT de la tabla `producto_valp`
--
ALTER TABLE `producto_valp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT de la tabla `tarifa_habitacion_valp`
--
ALTER TABLE `tarifa_habitacion_valp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- AUTO_INCREMENT de la tabla `tarifa_valp`
--
ALTER TABLE `tarifa_valp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
