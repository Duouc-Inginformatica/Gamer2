<?php
class Tarifa_valpData {
	public static $tablename = "tarifa_valp";

	public function Tarifa_valpData(){
		$this->nombre = "";
...
// partiendo de que ya tenemos creado un objecto TarifaData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new Tarifa_valpData());
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new Tarifa_valpData());
	}
