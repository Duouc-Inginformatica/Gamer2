<?php
class Product_valpData {
	public static $tablename = "product_valp";

	public function Product_valpData(){
		$this->name = "";
		$this->price_in = "";
		$this->price_out = "";
		$this->unit = "";
	...
	public function getCategory(){ return Categoria_valpData::getById($this->category_id);}
...
// partiendo de que ya tenemos creado un objecto ProductData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new Product_valpData());
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new Product_valpData());
	}
