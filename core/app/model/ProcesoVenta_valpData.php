<?php
class ProcesoVenta_valpData {
	public static $tablename = "proceso_venta_valp";


	public function ProcesoVenta_valpData(){
		$this->cantidad = ""; 
		$this->precio = "";
	...
	public function add(){ 
		$sql = "insert into proceso_venta_valp (id_producto,id_operacion,id_venta,cantidad,precio,fecha_creada,id_caja,id_usuario) ";
	...
	public function addCompra(){  
		$sql = "insert into proceso_venta_valp (id_producto,id_venta,cantidad,precio,tipo_operacion,fecha_creada,id_caja,id_usuario) ";
...
// partiendo de que ya tenemos creado un objecto PersonaData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new ProcesoVenta_valpData());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new ProcesoVenta_valpData());
	}
