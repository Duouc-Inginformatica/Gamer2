<?php
class Habitacion_valpData {
	public static $tablename = "habitacion_valp";



	public function Habitacion_valpData(){
		$this->nombre = ""; 
		$this->descripcion = "";
	...
	public function add(){
		$sql = "insert into habitacion_valp (nombre,descripcion,precio,id_categoria,estado,fecha_creada) ";
...
// partiendo de que ya tenemos creado un objecto HabitacionData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new Habitacion_valpData());
	...
	public static function getAll(){ 
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new Habitacion_valpData());
	}
