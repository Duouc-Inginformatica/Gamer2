<?php
class Proceso_valpData {
	public static $tablename = "proceso_valp";


	public function Proceso_valpData(){
		$this->dinero_dejado = ""; 
		$this->fecha_entrada = "";
		$this->fecha_salida = "";
		$this->cant_personas = "";
	...
	public function getTarifaHabitacion(){ return TarifaHabitacion_valpData::getById($this->id_tarifa);}
	public function getCliente(){ return Persona_valpData::getById($this->id_cliente);}
	public function getUsuario(){ return UserData::getById($this->id_usuario);}

	public function addIngreso(){
		$sql = "insert into proceso_valp (id_habitacion,id_tarifa,id_cliente,precio,cant_noche,dinero_dejado,id_tipo_pago,fecha_entrada,fecha_salida,id_usuario,cant_personas,id_caja,fecha_creada,cantidad,pagado) ";
...
// partiendo de que ya tenemos creado un objecto PersonaData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new Proceso_valpData());
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new Proceso_valpData());
	}
