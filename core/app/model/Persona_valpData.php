<?php
class Persona_valpData {
	public static $tablename = "persona_valp";


	public function Persona_valpData(){
		$this->documento = ""; 
		$this->nombre = "";
		$this->fecha_nac = "";
		$this->razon_social = ""; 
	...
	public function addCliente(){
		$sql = "insert into persona_valp (tipo_documento,documento,giro,nombre,fecha_nac,direccion,tipo,fecha_creada) ";
	...
	public function add(){
		$sql = "insert into persona_valp (tipo_documento,documento,nombre,giro,direccion,tipo,fecha_creada,nacionalidad,estado_civil,ocupacion,medio_transporte,destino,motivo) ";
	...
	public function add001(){
		$sql = "insert into persona_valp (tipo_documento,documento,nombre,direccion,tipo,fecha_creada) ";
	...
	public function addClienteVenta(){
		$sql = "insert into persona_valp (nombre,tipo,fecha_creada) ";
...
// partiendo de que ya tenemos creado un objecto PersonaData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new Persona_valpData());
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new Persona_valpData());
	}
