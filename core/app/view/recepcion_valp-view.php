...
<section class="content-header">
    <ol class="breadcrumb">
      ...
      <li class="active"><a href="#">recepciónValp</a></li>
    </ol>
</section> 
</div> 
  ...
  <div class="col-md-12">
    <section class="tile">
      <div class="tile-header dvd dvd-btm">
        <h1 class="custom-font"><strong> VISTA GENERAL</strong> RECEPCIÓN VALPARAISO</h1>
        <ul class="controls">
          <li class="remove">
      ...
      <div class="tile-body">
          <div class="row">
            <?php if(isset($_GET['buscar']) and $_GET['buscar']!=""){ ?>
                  <?php $cliente=Persona_valpData::getLike($_GET['buscar']); ?>
                  <?php $procesos = Proceso_valpData::getProcesoCliente($cliente->id);
                  if(count($procesos)>0){ ?> 
            ...
            <?php }else{ ?>
            <?php $habitaciones = Habitacion_valpData::getAll();
                   ...
                   <?php foreach($habitaciones as $habitacion):?>
                    ...
                    <div class="col-lg-2 col-xs-6">
                      ...
                      <?php $proceso = Proceso_valpData::getByRecepcion($habitacion->id);?>
                      <section class="tile bg-danger widget-appointments">
                            ...
                            <?php if($habitacion->estado==1){?>
                               <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    ...
                                    <ul class="controls"> 
                                      <li >
                                        <?php $tarifas_hab = TarifaHabitacion_valpData::getAllHabitacion($habitacion->id);
