...
<section class="content-header">
    <ol class="breadcrumb">
      <li><a href="index.php?view=reserva_valp"><i class="fa fa-home"></i> Inicio</a></li>
      <li><a href="javascript:;">Inventario Valparaiso</a></li>
      <li class="active"><a href="#">Kardex de Productos Valparaiso</a></li>
    </ol>
</section> 
  ...
  <div class="col-md-12">
    <section class="tile">
             ...
             <div class="tile-header dvd dvd-btm">  
                <h1 class="custom-font"><strong>Kardex Valparaiso</strong>  </h1>
                ...
                <ul class="controls">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right with-arrow animated littleFadeInUp">
                        <li><a id="print_saldos" href="reporte/pdf/documentos/reporte_kardex_todo_valp.php?anio=<?php echo $anio; ?>&mes=<?php echo $me; ?>" target="_blanck"
								><i class="icon-file-pdf"></i> Saldos y Movimientos</a></li>
						<li class="divider"></li>
						<li><a id="print_entradas" href="reporte/pdf/documentos/reporte_kardex_entrada_valp.php?anio=<?php echo $anio; ?>&mes=<?php echo $me; ?>" target="_blanck">
						<i class="icon-file-pdf"></i> Entradas del Mes</a></li>
						<li class="divider"></li>
						<li><a id="print_salidas" href="reporte/pdf/documentos/reporte_kardex_salida_valp.php?anio=<?php echo $anio; ?>&mes=<?php echo $me; ?>" target="_blanck">
           ...
           <div class="tile-body">
            <div class="form-group">
              ...
              <?php $productos = Product_valpData::getAll();
                      ...
                      <tr>
                        ...
                        <?php  
                            if(isset($_GET['anio']) and isset($_GET['mes']) and $_GET['anio']!='' and $_GET['mes']!='00'){
                                    ...
                                    $entrada_producto=0; 
                                    $entradas = ProcesoVenta_valpData::getAllEntradasMes($producto->id,$_GET['mes'],$_GET['anio']);
                                    if(count($entradas)>0){ 
                                     ...
                                     $salida_producto=0;
                                     $salidas = ProcesoVenta_valpData::getAllSalidasMes($producto->id,$_GET['mes'],$_GET['anio']);
                                     if(count($salidas)>0){ 
                                    ...
                                    $entrada_producto=0; 
                                    $entradas = ProcesoVenta_valpData::getAllEntradas($producto->id);
                                    if(count($entradas)>0){ 
                                      foreach($entradas as $entrada): $entrada_producto=$entrada->cantidad+$entrada_producto;  
                                      endforeach;
                                    }else{ $entrada_producto=0; }; 
                                    ...
                                    $salida_producto=0;
                                     $salidas = ProcesoVenta_valpData::getAllSalidas($producto->id);
                                     if(count($salidas)>0){ 
                                     foreach($salidas as $salida): $salida_producto=$salida->cantidad+$salida_producto;  
                                      endforeach; 
                                     }else{ $salida_producto=0; }; 
