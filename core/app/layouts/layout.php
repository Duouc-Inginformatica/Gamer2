        ...
        <div id="wrap" class="animsition">
            ...
            <section id="header">
                <header class="clearfix">
                    ...
                    <div class="branding">
                        <a class="brand" href="./">
                            <span><strong>Hoteles | Veranum</strong></span>
                        </a>
                                ...
                                ?>
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li class="<?php if($_GET['view']=='recepcion'){ echo 'active';} ?>">
                                                <a href="index.php?view=recepcion"><i class="fa fa-sign-in"></i> <span>Recepción Santiago</span> <span class="badge bg-lightred">+99</span></a>
                                                <a href="index.php?view=recepcion_valp"><i class="fa fa-sign-in"></i> <span>Recepción Valparaiso</span> <span class="badge bg-lightred">2</span></a>
                                            ...
                                            <li class="<?php if($_GET['view']=='kardex' or $_GET['view']=='compra' or $_GET['view']=='lista_compra'  ){ echo 'active';} ?> ">
                                                <a role="button" tabindex="0"><i class="fa fa-edit"></i> <span>Inventario Santiago</span></a>
                                                <ul>
                                            ...
                                            <li class="<?php if($_GET['view']=='kardex' or $_GET['view']=='compra' or $_GET['view']=='lista_compra'  ){ echo 'active';} ?> ">
                                                <a role="button" tabindex="0"><i class="fa fa-edit"></i> <span>Inventario Valparaiso</span></a>
                                                <ul>
                                                    <li><a href="./?view=kardex_valp"><i class="fa fa-caret-right"></i> Kardex</a></li>
                                                    <li><a href="./?view=compra_valp"><i class="fa fa-caret-right"></i> Reabastecer</a></li>
                                                    <li><a href="./?view=lista_compra_valp"><i class="fa fa-caret-right"></i> Consulta compra por fecha</a></li>
                                                </ul>
                                            </li>
...
<img src="assets/images/bg//blurred-bg-3.jpg" class="login-img wow fadeIn" alt="">
 ...
 <!-- col -->
                        ...
                        ?>
                                    ...
                                    <center><h1><b>Hoteles Veranum 2.1</b></h1><br><?php if($logo!=''){ ?><img width="50%" src="img/<?php echo $logo; ?>"><?php }; ?></center>
                                ...
                                <div class="tile-body">
                                    ...
                                    <form role="form" action="./?action=processlogin" method="post"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password" required="" class="form-control" id="exampleInputPassword1" placeholder="Ingrese su contraseña">
                                        </div>
                                        ...
                                        <div class="form-group">
                                                <button type="submit" style="background-color: #2775ad;color: white;" class="btn btn-rounded btn-primary btn form-control">Ingresar</button>
