...
$stmt->execute();
echo"<script>alert('Registro Satisfactorio de Cliente');</script>";
}
?>
...
<head>
	...
	<title>Hoteles Veranum Registro</title>
...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
			<h3 style="color: red" align="left">Habitacion ya reservado por ti</h3>
				<?php }
				else{
							echo "";
							}			
...
<div class="form-group">
<label class="col-sm-2 control-label">Se queda desde</label>
<div class="col-sm-8">
