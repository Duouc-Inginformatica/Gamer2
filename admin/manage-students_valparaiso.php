...
{
	$id=intval($_GET['del']);
	$adn="delete from registration_valp where id=?";
	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						</br></br><h2 class="page-title">Administración de Registro de Cliente VALPARAISO</h2>
...
<?php	
$aid=$_SESSION['id'];
$ret="select * from registration_valp";
