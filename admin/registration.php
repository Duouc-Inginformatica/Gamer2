...
$stmt1->execute();
echo"<script>alert('Registro de Cliente Satisfactorio');</script>";
}
?>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Formulario de Registro ADMINISTRATIVO </h2>
...
<input type="radio" value="1" name="foodstatus"> Con Comida(CLP 32.000 Por mes Extra)
</div>
</div>	
...
<option value="others">Helicoptero Apache</option>
</select>
</div>
</div>
...
<div class="form-group">
<label class="col-sm-5 control-label">Es la misma dirección de Emergencia? : </label>
<div class="col-sm-4">
